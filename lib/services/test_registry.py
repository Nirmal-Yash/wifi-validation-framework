    ...
    def default(cls) -> "TestRegistry":
        return cls(
            (
                ...
                TestDefinition(
                    "wifi.auth.wrong_psk",
                    "tests/test_negative_recovery.py::test_wrong_psk_rejected_and_recovers",
                    "1.0", "Recovery", "WPA2/EAPOL",
                    Severity.HIGH, Criticality.BLOCKING,
                    ("ap_host", "client_vm"), "client→AP",
                    requires=("wifi.auth.wpa2",),
                ...
                TestDefinition(
                    "wifi.recovery.disconnect_reconnect",
                    "tests/test_negative_recovery.py::test_wifi_disconnect_reconnect_recovers",
                    "1.0", "Recovery", "802.11",
                    Severity.HIGH, Criticality.BLOCKING,
                    ("client_vm",), "client↔router",
                    requires=("wifi.ping.success",),
                    destructive=True, estimated_duration_sec=30,
                    capabilities=("wifi_disconnect",),
                    metric_definitions={
                        "fault_observed": "bool",
                        "recovery_time": "seconds",
                    },
                ...
                TestDefinition(
                    "wifi.dhcp.renewal",
                    "tests/test_negative_recovery.py::test_dhcp_renewal_preserves_reserved_address",
                    "1.0", "Recovery", "DHCP",
                    Severity.HIGH, Criticality.BLOCKING,
                    ("router", "client_vm"), "router→client",
                    requires=("wifi.dhcp.lease",),
                ...
                TestDefinition(
                    ...
                    "tests/test_negative_recovery.py::test_dhcp_server_failure_and_recovery",
                    "1.0", "Recovery", "DHCP",
                    Severity.HIGH, Criticality.BLOCKING,
                    ("router", "client_vm"), "router↔client",
                    requires=("wifi.dhcp.lease",),
                    destructive=True, estimated_duration_sec=45,
                    capabilities=("dhcp", "service_control"),
                    metric_definitions={
                        "fault_observed": "bool",
                        "recovery_time": "seconds",
                    },
                ...
                TestDefinition(
                    "wifi.dns.failure_recovery",
                    "tests/test_negative_recovery.py::test_dns_failure_and_recovery",
                    "1.0", "Recovery", "DNS",
                    Severity.HIGH, Criticality.BLOCKING,
                    ("router", "client_vm"), "client→resolver",
                    requires=("wifi.dns.resolution",),
                    destructive=True, estimated_duration_sec=30,
                    capabilities=("dns", "firewall_control"),
                    metric_definitions={
                        "fault_observed": "bool",
                        "recovery_time": "seconds",
                    },
                ...
                TestDefinition(
                    "wifi.recovery.ap_restart",
                    "tests/test_negative_recovery.py::test_ap_restart_recovers_wifi",
                    "1.0", "Recovery", "802.11",
                    Severity.HIGH, Criticality.BLOCKING,
                    ("ap_host", "client_vm"), "AP↔client",
                    requires=("wifi.auth.wpa2", "wifi.ping.success"),
                    destructive=True, estimated_duration_sec=60,
                    capabilities=("ap_service_control",),
                    metric_definitions={
                        "fault_observed": "bool",
                        "recovery_time": "seconds",
                    },
                ...
                TestDefinition(
                    "wifi.recovery.client_wifi_restart",
                    "tests/test_negative_recovery.py::test_client_wifi_restart_recovers",
                    "1.0", "Recovery", "802.11",
                    Severity.HIGH, Criticality.BLOCKING,
                    ("client_vm",), "client↔AP",
                    requires=("wifi.auth.wpa2", "wifi.ping.success"),
                    destructive=True, estimated_duration_sec=60,
                    capabilities=("client_service_control",),
                    metric_definitions={
                        "fault_observed": "bool",
                        "recovery_time": "seconds",
                    },
